...
for k, v, w in ([[
	...
	NOTIFICATION_SPY_CREATED_ACTIVE_PLAYER		NewSpy
	NOTIFICATION_SPY_CANT_STEAL_TECH		SpyCannotSteal
	NOTIFICATION_SPY_EVICTED			Spy
	NOTIFICATION_TECH_STOLEN_SPY_DETECTED		Spy
	NOTIFICATION_TECH_STOLEN_SPY_IDENTIFIED		Spy
	NOTIFICATION_SPY_KILLED_A_SPY			SpyKilledASpy
	NOTIFICATION_SPY_WAS_KILLED			SpyWasKilled
	NOTIFICATION_SPY_REPLACEMENT			Spy
	NOTIFICATION_SPY_PROMOTION			SpyPromotion
	NOTIFICATION_INTRIGUE_DECEPTION			Spy

	NOTIFICATION_INTRIGUE_BUILDING_SNEAK_ATTACK_ARMY			Spy
	NOTIFICATION_INTRIGUE_BUILDING_SNEAK_ATTACK_AMPHIBIOUS			Spy
	NOTIFICATION_INTRIGUE_SNEAK_ATTACK_ARMY_AGAINST_KNOWN_CITY_UNKNOWN	Spy
	NOTIFICATION_INTRIGUE_SNEAK_ATTACK_ARMY_AGAINST_KNOWN_CITY_KNOWN	Spy
	NOTIFICATION_INTRIGUE_SNEAK_ATTACK_ARMY_AGAINST_YOU_CITY_UNKNOWN	Spy
	NOTIFICATION_INTRIGUE_SNEAK_ATTACK_ARMY_AGAINST_YOU_CITY_KNOWN		Spy
	NOTIFICATION_INTRIGUE_SNEAK_ATTACK_ARMY_AGAINST_UNKNOWN			Spy
	NOTIFICATION_INTRIGUE_SNEAK_ATTACK_AMPHIB_AGAINST_KNOWN_CITY_UNKNOWN	Spy
	NOTIFICATION_INTRIGUE_SNEAK_ATTACK_AMPHIB_AGAINST_KNOWN_CITY_KNOWN	Spy
	NOTIFICATION_INTRIGUE_SNEAK_ATTACK_AMPHIB_AGAINST_YOU_CITY_UNKNOWN	Spy
	NOTIFICATION_INTRIGUE_SNEAK_ATTACK_AMPHIB_AGAINST_YOU_CITY_KNOWN	Spy
	NOTIFICATION_INTRIGUE_SNEAK_ATTACK_AMPHIB_AGAINST_UNKNOWN		Spy
	NOTIFICATION_INTRIGUE_CONSTRUCTING_WONDER				Spy
	...
	NOTIFICATION_SPY_STAGE_COUP_SUCCESS		Spy
	NOTIFICATION_SPY_STAGE_COUP_FAILURE		Spy

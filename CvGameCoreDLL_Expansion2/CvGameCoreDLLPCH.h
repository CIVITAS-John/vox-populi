...
#define PRECONDITION(expr, ...) ASSERT(expr) // if (!(expr)) {CvString str; CvString::format(str, __VA_ARGS__); CvPreconditionDlg(#expr, __FILE__, __LINE__, str.c_str()); BUILTIN_TRAP();}

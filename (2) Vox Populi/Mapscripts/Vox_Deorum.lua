...
function MapGlobals:New()
	...
	-- Force override AssignStartingPlots
	overrideAssignStartingPlots = true;

	-- World Age
	-- Forced normal world age
	local oWorldAge = 2;
	if oWorldAge == 1 then
		print("Map Age: New");
	...
	-- Land Shapes
	-- Forced normal scatter
	local oLandScatter = 2;
	local scatterOdds = 1;
...
function GetMapScriptInfo()
	...
	return {
		Name = "Vox Deorum (Communitu_79a v3.1.0)",
		Description = "Used for academic research - fixing many parameters",
		IsAdvancedMap = false,
